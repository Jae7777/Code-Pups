  ...
  return (
    <>
      <div class="justify-center items-center">
        <div class="text-indigo-400 text-center pt-5">
          <h1 className="text-[40px] md:text-[60px] lg:text-[70px] 
          font-bold">THE TEAM</h1>
        </div>
        <div class="md:flex rounded-xl px-20 sm:px-16 lg:px-[200px] py-8">
          <img class="mx-auto my-auto w-32 h-32 rounded-full " src={justin} alt="" />
